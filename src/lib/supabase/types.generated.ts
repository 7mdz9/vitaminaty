  ...
  public: {
    ...
    Enums: {
      audit_action:
        ...
        | "image_upload"
        | "role_change";
      goal_tag: "build_muscle" | "boost_energy" | "recovery" | "weight_management" | "endurance";
      image_kind:
        | "front"
        | "label_nutrition"
        | "label_ingredients"
...
export const Constants = {
  ...
  public: {
    Enums: {
      ...
      goal_tag: ["build_muscle", "boost_energy", "recovery", "weight_management", "endurance"],
      image_kind: ["front", "label_nutrition", "label_ingredients", "angle", "open", "lifestyle"],
      order_status: [
        "pending_payment",
        "paid",
        "preparing",
      ...
      payment_method: ["card", "apple_pay", "tabby", "tamara", "cod"],
      product_form: ["powder", "capsule", "tablet", "softgel", "gummies", "liquid", "rtd", "food"],
      product_status: [
        "imported",
        "draft",
        "partial",
